  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 font-sans">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-4">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Freelance Job Board</h1>
        ...
        {filteredJobs.map((job) => (
          <div key={job.UNIQUE_ID}>
            <Card className="p-2 hover:shadow-md hover:border-secondary/30 transition-all duration-200">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  {/* Description */}
                  <p className="text-gray-700 text-[11px] leading-tight">{job.Summary}</p>
                </div>
              </div>
            </Card>
          </div>
